 ...
 * class wraps the default PHP session machinery.
 *
 * @package Hlad
 */
class Auth_Yadis_PHPSession {
	...
	function __construct() {
		if (!self::$namespace) {
			...
			self::$namespace = $session->getNamespace('openid');
		}
	}
 ...
 * @package OpenID
 */
class Auth_Yadis_PHPSession_SUBCLASSED {
    /**
     * Set a session key/value pair.
     *
     * @param string $name The name of the session key to add.
